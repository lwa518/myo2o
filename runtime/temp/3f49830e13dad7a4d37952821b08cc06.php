<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"C:\Apache24\htdocs\myo2o\public/../application/admin\view\bis_location\detail.html";i:1520416752;s:76:"C:\Apache24\htdocs\myo2o\public/../application/admin\view\public\header.html";i:1489469586;s:76:"C:\Apache24\htdocs\myo2o\public/../application/admin\view\public\footer.html";i:1489469586;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
  ...
  <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('location/add'); ?>">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-3">
        <input type="text" class="input-text" value="<?php echo $locationData['name']; ?>" placeholder="" id="" name="name">
      </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-2">
				...
				<select name="city_id" class="select cityId">
                  ...
                  <option value="<?php echo $vo['id']; ?>" <?php if($locationData['city_id'] == $vo['id']): ?> selected="selected"<?php endif; ?>><?php echo $vo['name']; ?></option>
      ...
      <div class="formControls col-xs-8 col-sm-2">
          ...
          <option value="0"><?php echo getSeCityName($locationData['city_path']); ?></option> 
        </select>
				</span>
      </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <img  src="<?php echo $locationData['logo']; ?>" width="150" height="150">
      </div>
    </div>
    <div class="row cl">
