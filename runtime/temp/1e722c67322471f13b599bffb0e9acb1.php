<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"/var/www/html/myo2o/public/../application/admin/view/index/index.html";i:1520584826;s:71:"/var/www/html/myo2o/public/../application/admin/view/public/header.html";i:1520584826;s:69:"/var/www/html/myo2o/public/../application/admin/view/public/menu.html";i:1520584826;s:71:"/var/www/html/myo2o/public/../application/admin/view/public/footer.html";i:1520584826;}*/ ?>
﻿<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="">o2o平台</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href=""></a> <span class="logo navbar-slogan f-l mr-10 hidden-xs"></span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li>超级管理员</li>
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A"><?=session('suser','', 'myo2o')['username'];?> <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="#">个人信息</a></li>
							<li><a href="<?php echo url('index/logout'); ?>">切换账户</a></li>
		...
		<dl id="menu-article">
			...
			<dd>
				<ul>
					...
					<li><a _href="<?php echo url('bisLocation/index'); ?>" data-title="门店管理" href="javascript:void(0)">门店管理</a></li>
					<li><a _href="<?php echo url('bisLocation/apply'); ?>" data-title="门店管理" href="javascript:void(0)">门店申请</a></li>
					<li><a _href="<?php echo url('bis/deleted'); ?>" data-title="删除的商户" href="javascript:void(0)">删除的商户</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					...
					<li><a _href="<?php echo url('user/deleted'); ?>" data-title="删除的会员" href="javascript:;">删除的会员</a></li>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		...
		<div class="Hui-tabNav-more btn-group"><a id="js-tabNav-prev" class="btn radius btn-default size-S" href="javascript:;"><i class="Hui-iconfont">&#xe6d4;</i></a><a id="js-tabNav-next" class="btn radius btn-default size-S" href="javascript:void(0);"><i class="Hui-iconfont">&#xe6d7;</i></a></div>
	</div>
