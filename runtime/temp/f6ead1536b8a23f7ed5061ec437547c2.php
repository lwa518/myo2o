<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"/var/www/html/myo2o/public/../application/bis/view/register/index.html";i:1520592505;s:69:"/var/www/html/myo2o/public/../application/bis/view/public/header.html";i:1520584828;s:69:"/var/www/html/myo2o/public/../application/bis/view/public/footer.html";i:1520584828;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
	...
	基本信息：
		...
		<div class="row cl">
            ...
            <div class="layui-upload" ">
				<button style="background-color: #505050;margin-left: 18px;" type="button" class="layui-btn" id="test1">上传图片</button>
				<div class="layui-upload-list " >
				    <img class="layui-upload-img col-xs-offset-4 col-sm-offset-2"   id="file1">
				    <p id="demoText"></p>
				</div>
			</div> 
        </div>
        <input type="text" name="logo" id='logo' style="visibility: hidden;" value="">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">营业执照：</label>
            <div class="layui-upload">
				<button style="background-color: #505050;margin-left: 18px;" type="button" class="layui-btn" id="test2">上传图片</button>
				<div class="layui-upload-list ">
					<img class="layui-upload-img col-xs-offset-4 col-sm-offset-2"   id="file2">
					<p id="demoText"></p>
				</div>
            </div> 
        </div>
        <input type="text" name="licence_logo" id='licence_logo' style="visibility: hidden;" value="">
		<div class="row cl">
...
<script>
	var SCOPE={
		'city_url':'/myo2o/public/index.php/api/city/getCitysByParentId.html',
		'category_url':'/myo2o/public/index.php/api/category/getCategoryByParentId.html',
};
</script>
