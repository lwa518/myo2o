<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"C:\Apache24\htdocs\myo2o\public/../application/index\view\detail\index.html";i:1520495221;s:74:"C:\Apache24\htdocs\myo2o\public/../application/index\view\public\head.html";i:1520487122;s:73:"C:\Apache24\htdocs\myo2o\public/../application/index\view\public\nav.html";i:1520402755;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <div class="p-item-info-more">
    <div class="iim-wrapper">
      ...
      <ul class="j-info-all">
              ...
              <div class="branch-content">
                <div class="shop-map">
                  <div class="w-map">
                    ...
                    <img src="http://api.map.baidu.com/staticimage/v2?ak=YPMXzsRcmF7s04utbrg5Dj2NUMQ5qrF2&center=<?php echo $locations[0]['xpoint']; ?>,<?php echo $locations[0]['ypoint']; ?>&width=450&height=300&zoom=18&markers=<?php echo $locations[0]['xpoint']; ?>,<?php echo $locations[0]['ypoint']; ?>&markerStyles=s,A,0xff0000">
                  </div>
                </div>
        ...
        <li class="tab"><div class="ifram">消费提示</div></li>
        <li class="tab"><div class="ifram"><img src=""></div></li>
      </ul>
    </div>
  </div>
</div>
