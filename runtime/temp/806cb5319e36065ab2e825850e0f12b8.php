...
<div class="page-container">
  ...
  <div class="mt-20">
    <table class="table table-border table-bordered table-bg table-hover table-sort">
      ...
      <tbody>
<?php if(is_array($bises) || $bises instanceof \think\Collection): $i = 0; $__LIST__ = $bises;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
      <tr class="text-c">
        <td><?php echo $vo['id']; ?></td>
        <td><?php echo $vo['name']; ?></td>
        <td><?php echo date("y-m-d h:i", $vo['create_time']); ?></td>
        <td><?php echo !empty($vo['is_main'])?'是':'否'; ?></td>
